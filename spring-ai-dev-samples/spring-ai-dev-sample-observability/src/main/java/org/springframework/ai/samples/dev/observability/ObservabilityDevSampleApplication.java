...
package org.springframework.ai.samples.dev.observability;
...
public class ObservabilityDevSampleApplication {

	public static void main(String[] args) {
		SpringApplication.run(ObservabilityDevSampleApplication.class, args);
	}
